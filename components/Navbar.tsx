  ...
  return (
    <header className="w-full h-auto absolute top-0 left-0">
      <nav className="bg-black w-full h-auto flex justify-center items-start relative">
        <div className="navbar z-10 absolute top-0 flex justify-between items-center w-11/12 sm:w-9/12 pt-8">
          <span className="logo">
            <p className=" font-primary text-xl sm:text-2xl font-semibold tracking-widest">
              CLIENET.
            </p>
          </span>
          <span className="menu-icon">
            <Image
              src="./svg/Menu_Arrow.svg"
              alt="menu"
              width={50}
              height={50}
              className="Menu-icon 2xl:w-16 w-10 sm:w-12 "
            />
          </span>
        </div>
        <div className="menu w-full h-screen bg-bright-yellow overflow-hidden flex justify-center">
